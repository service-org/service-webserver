...
def get_swagger_ui_html(
        *,
        ...
        swagger_favicon_url: t.Text = 'https://fastapi.tiangolo.com/img/favicon.png',
        swagger_css_url: t.Text = 'https://cdn.jsdelivr.net/npm/swagger-ui-dist@3/swagger-ui.css',
        swagger_js_url: t.Text = 'https://cdn.jsdelivr.net/npm/swagger-ui-dist@3/swagger-ui-bundle.js'
) -> t.Text:
    """ 获取SwaggerUI接口列表页内容

    @param title: swagger ui文档标题
    @param openapi_url: openapi json地址
